...
public class Basket {
    ...
    public final Map<Item, Integer> order = new TreeMap<>();
    ...
    public void add(Item item, int quantity) {
        ...
        }else if (quantity > item.getQuantiti()){
            throw new IllegalStateException(String.format("There is no that many items to add"));
        }
